...
// APIClient manages communication with the Nuki API API vv1
...
type APIClient struct {
	...
	AddressReservationApi *AddressReservationApiService

	AddressTokenApi *AddressTokenApiService

	AdvancedApiApi *AdvancedApiApiService
	...
	OpenerApi *OpenerApiService

	ServiceApi *ServiceApiService

	SmartlockApi *SmartlockApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.AddressTokenApi = (*AddressTokenApiService)(&c.common)
	c.AdvancedApiApi = (*AdvancedApiApiService)(&c.common)
	...
	c.OpenerApi = (*OpenerApiService)(&c.common)
