...
@return Service
*/
func (a *ServiceApiService) Get(ctx context.Context, serviceId string) (Service, *http.Response, error) {
	var (
...
@return string
*/
func (a *ServiceApiService) Post(ctx context.Context, serviceId string) (string, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/{serviceId}/link"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceId"+"}", fmt.Sprintf("%v", serviceId), -1)
...
func (a *ServiceApiService) Post_1(ctx context.Context, serviceId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/{serviceId}/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceId"+"}", fmt.Sprintf("%v", serviceId), -1)
...
func (a *ServiceApiService) Post_2(ctx context.Context, serviceId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/{serviceId}/unlink"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceId"+"}", fmt.Sprintf("%v", serviceId), -1)
