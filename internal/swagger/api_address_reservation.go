...
*/
func (a *AddressReservationApiService) Get(ctx context.Context, addressId int32) ([]AddressReservation, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/address/{addressId}/reservation"
...
func (a *AddressReservationApiService) Post(ctx context.Context, addressId int32, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/address/{addressId}/reservation/{id}/issue"
	localVarPath = strings.Replace(localVarPath, "{"+"addressId"+"}", fmt.Sprintf("%v", addressId), -1)
...
func (a *AddressReservationApiService) Post_1(ctx context.Context, addressId int32, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/address/{addressId}/reservation/{id}/revoke"
	localVarPath = strings.Replace(localVarPath, "{"+"addressId"+"}", fmt.Sprintf("%v", addressId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
